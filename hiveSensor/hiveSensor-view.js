...
export default function CCHiveSensorView({itemState, appPrefs, onListLimitChange,
	onSearchChange, onSearchClick, onPaginationClick, onOrderBy, onOption,
	closeModal, inputChange, goBack, session}) {

    let columns = [];
    if (itemState.prefLabels != null && itemState.prefLabels.CC_HIVESENSOR_PAGE != null) {
    	columns = itemState.prefLabels.CC_HIVESENSOR_PAGE;
    }
    let group = "TABLE1";
	...
	if (itemState.prefTexts.CC_HIVESENSOR_PAGE != null && itemState.prefTexts.CC_HIVESENSOR_PAGE.CC_HIVESENSOR_PAGE_HEADER != null) {
		header = itemState.prefTexts.CC_HIVESENSOR_PAGE.CC_HIVESENSOR_PAGE_HEADER.value;
	}
